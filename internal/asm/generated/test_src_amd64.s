...
TEXT ·Test_fn_sq_floats(SB), NOSPLIT, $0-48
	...
	WORD $0x930f; BYTE $0xc2   // SETAE DL                             // setae	dl
	WORD $0xd084               // TESTL DL, AL                         // test	al, dl
	JNE  LBB10_8               // <--                                  // jne	.LBB10_8
	XORL AX, AX                // <--                                  // xor	eax, eax
	JMP  LBB10_3               // <--                                  // jmp	.LBB10_3

LBB10_8:
	QUAD $0xfffffffffff8b848; WORD $0x7fff // MOVQ $0x7ffffffffffffff8, AX         // movabs	rax, 9223372036854775800
	ANDQ SI, AX                            // <--                                  // and	rax, rsi
...
LBB10_9:
	...
	JE   LBB10_11                // <--                                  // je	.LBB10_11

LBB10_3:
	MOVQ SI, R8   // <--                                  // mov	r8, rsi
	MOVQ AX, DX   // <--                                  // mov	rdx, rax
	ANDQ $0x3, R8 // <--                                  // and	r8, 3
	JE   LBB10_6  // <--                                  // je	.LBB10_6
	MOVQ AX, DX   // <--                                  // mov	rdx, rax

LBB10_5:
	LONG $0x04100ff3; BYTE $0x97 // MOVSS 0(DI)(DX*4), X0                // movss	xmm0, dword ptr [rdi + 4*rdx]
	LONG $0xc0590ff3             // MULSS X0, X0                         // mulss	xmm0, xmm0
	LONG $0x04110ff3; BYTE $0x91 // MOVSS X0, 0(CX)(DX*4)                // movss	dword ptr [rcx + 4*rdx], xmm0
	INCQ DX                      // <--                                  // inc	rdx
	DECQ R8                      // <--                                  // dec	r8
	JNE  LBB10_5                 // <--                                  // jne	.LBB10_5

LBB10_6:
	SUBQ SI, AX    // <--                                  // sub	rax, rsi
	CMPQ AX, $-0x4 // <--                                  // cmp	rax, -4
	JA   LBB10_11  // <--                                  // ja	.LBB10_11

LBB10_7:
	LONG $0x04100ff3; BYTE $0x97   // MOVSS 0(DI)(DX*4), X0                // movss	xmm0, dword ptr [rdi + 4*rdx]
	LONG $0xc0590ff3               // MULSS X0, X0                         // mulss	xmm0, xmm0
	LONG $0x04110ff3; BYTE $0x91   // MOVSS X0, 0(CX)(DX*4)                // movss	dword ptr [rcx + 4*rdx], xmm0
	LONG $0x44100ff3; WORD $0x0497 // MOVSS 0x4(DI)(DX*4), X0              // movss	xmm0, dword ptr [rdi + 4*rdx + 4]
	LONG $0xc0590ff3               // MULSS X0, X0                         // mulss	xmm0, xmm0
	LONG $0x44110ff3; WORD $0x0491 // MOVSS X0, 0x4(CX)(DX*4)              // movss	dword ptr [rcx + 4*rdx + 4], xmm0
	LONG $0x44100ff3; WORD $0x0897 // MOVSS 0x8(DI)(DX*4), X0              // movss	xmm0, dword ptr [rdi + 4*rdx + 8]
	LONG $0xc0590ff3               // MULSS X0, X0                         // mulss	xmm0, xmm0
	LONG $0x44110ff3; WORD $0x0891 // MOVSS X0, 0x8(CX)(DX*4)              // movss	dword ptr [rcx + 4*rdx + 8], xmm0
	LONG $0x44100ff3; WORD $0x0c97 // MOVSS 0xc(DI)(DX*4), X0              // movss	xmm0, dword ptr [rdi + 4*rdx + 12]
	LONG $0xc0590ff3               // MULSS X0, X0                         // mulss	xmm0, xmm0
	LONG $0x44110ff3; WORD $0x0c91 // MOVSS X0, 0xc(CX)(DX*4)              // movss	dword ptr [rcx + 4*rdx + 12], xmm0
