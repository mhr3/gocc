...
LBB0_14:
	...
	WORD $0x894d; BYTE $0xca // MOVQ R9, R10;	mov	r10, r9
...
LBB0_15:
	...
	LONG $0x0a048842             // MOVB AL, 0(DX)(R9*1);	mov	byte ptr [rdx + r9], al
...
LBB0_17:
	...
	LONG $0x0a448842; BYTE $0x01   // MOVB AL, 0x1(DX)(R9*1);	mov	byte ptr [rdx + r9 + 1], al
	...
	LONG $0x0a448842; BYTE $0x02   // MOVB AL, 0x2(DX)(R9*1);	mov	byte ptr [rdx + r9 + 2], al
	...
	LONG $0x0a448842; BYTE $0x03   // MOVB AL, 0x3(DX)(R9*1);	mov	byte ptr [rdx + r9 + 3], al
...
LBB0_7:
	...
	LONG    $0x7fe28341         // ANDL $0x7f, R10;	and	r10d, 127
	WORD    $0x894d; BYTE $0xc1 // MOVQ R8, R9;	mov	r9, r8
...
LBB0_8:
	LONG $0x1c6ffec5; BYTE $0x07   // VMOVDQU 0(DI)(AX*1), X3;	vmovdqu	ymm3, ymmword ptr [rdi + rax]
	LONG $0x646ffec5; WORD $0x2007 // VMOVDQU 0x20(DI)(AX*1), X4;	vmovdqu	ymm4, ymmword ptr [rdi + rax + 32]
	LONG $0x6c6ffec5; WORD $0x4007 // VMOVDQU 0x40(DI)(AX*1), X5;	vmovdqu	ymm5, ymmword ptr [rdi + rax + 64]
	LONG $0x4c6ffec5; WORD $0x6007 // VMOVDQU 0x60(DI)(AX*1), X1;	vmovdqu	ymm1, ymmword ptr [rdi + rax + 96]
	LONG $0x346ffec5; BYTE $0x06   // VMOVDQU 0(SI)(AX*1), X6;	vmovdqu	ymm6, ymmword ptr [rsi + rax]
	LONG $0x7c6ffec5; WORD $0x2006 // VMOVDQU 0x20(SI)(AX*1), X7;	vmovdqu	ymm7, ymmword ptr [rsi + rax + 32]
	LONG $0x446f7ec5; WORD $0x4006 // VMOVDQU 0x40(SI)(AX*1), X8;	vmovdqu	ymm8, ymmword ptr [rsi + rax + 64]
	LONG $0x546ffec5; WORD $0x6006 // VMOVDQU 0x60(SI)(AX*1), X2;	vmovdqu	ymm2, ymmword ptr [rsi + rax + 96]
	...
	LONG $0x1c7ffec5; BYTE $0x02   // VMOVDQU X3, 0(DX)(AX*1);	vmovdqu	ymmword ptr [rdx + rax], ymm3
	LONG $0x647ffec5; WORD $0x2002 // VMOVDQU X4, 0x20(DX)(AX*1);	vmovdqu	ymmword ptr [rdx + rax + 32], ymm4
	LONG $0x6c7ffec5; WORD $0x4002 // VMOVDQU X5, 0x40(DX)(AX*1);	vmovdqu	ymmword ptr [rdx + rax + 64], ymm5
	LONG $0x4c7ffec5; WORD $0x6002 // VMOVDQU X1, 0x60(DX)(AX*1);	vmovdqu	ymmword ptr [rdx + rax + 96], ymm1
	LONG $0x80e88348               // SUBQ $-0x80, AX;	sub	rax, -128
	...
	LONG $0x10fa8341               // CMPL $0x10, R10;	cmp	r10d, 16
	JB   LBB0_14                   // jb	.LBB0_14

LBB0_11:
	WORD    $0x894c; BYTE $0xc8 // MOVQ R9, AX;	mov	rax, r9
	WORD    $0x8941; BYTE $0xca // MOVL CX, R10;	mov	r10d, ecx
