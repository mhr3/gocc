...
LBB0_2:
	...
	WORD  $0x4e201c22        // VAND V0.B16, V1.B16, V2.B16          // and	v2.16b, v1.16b, v0.16b
...
LBB0_6:
	...
	WORD  $0x0e211c01        // VAND V1.B8, V0.B8, V1.B8             // and	v1.8b, v0.8b, v1.8b
	WORD  $0x2e30a821        // VUMAXV V1.B8, V1                     // umaxv	b1, v1.8b
	...
	WORD  $0x0ea21c00        // VORR V2.B8, V0.B8, V0.B8             // orr	v0.8b, v0.8b, v2.8b
...
LBB1_3:
	...
	WORD  $0x4e201c21 // VAND V0.B16, V1.B16, V1.B16          // and	v1.16b, v1.16b, v0.16b
